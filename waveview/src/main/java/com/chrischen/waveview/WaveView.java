...
public class WaveView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        lineWidth = typedArray.getDimensionPixelSize(R.styleable.WaveView_wvLineWidth, 1);
        lineSpace = typedArray.getDimensionPixelSize(R.styleable.WaveView_wvLineSpace, 1);
