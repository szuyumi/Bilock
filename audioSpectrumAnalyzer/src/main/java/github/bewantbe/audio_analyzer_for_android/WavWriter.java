...
public class WavWriter {
    ...
    final String trainModeDir = "/ModeRecord";
    final String waveRecordDir = "/TestRecord";
    String currentDir =waveRecordDir ;
    ...
    public boolean start(boolean mode) {

        if (!isExternalStorageWritable()) {
            return false;
        }
        currentDir = waveRecordDir;

        File path = new File(Environment.getExternalStorageDirectory().getPath() + currentDir);
        path.mkdirs();
